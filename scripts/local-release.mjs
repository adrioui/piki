...
const packages = [
	{ directory: "packages/ai", name: "@piki/ai" },
	{ directory: "packages/tui", name: "@piki/tui" },
	{ directory: "packages/agent", name: "@piki/agent-core" },
	{ directory: "packages/coding-agent", name: "@piki/coding-agent" },
];
