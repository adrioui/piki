...
async function generateModels() {
	...
	// Auth via DASHSCOPE_API_KEY env var. See https://www.qwencloud.com/
	...
	const qwencloudReasoningCompat: OpenAICompletionsCompat = {
		...qwencloudCompat,
		thinkingFormat: "qwen",
		requiresReasoningContentOnAssistantMessages: true,
	};
	const QWENCLOUD_BASE_URL = "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
	const qwencloudModels: Model<"openai-completions">[] = [
		{
			id: "qwen3.7-plus",
			name: "Qwen 3.7 Plus",
			api: "openai-completions",
			...
			contextWindow: 131072,
			maxTokens: 65536,
			compat: qwencloudReasoningCompat,
		},
		{
			id: "qwen3.7-max",
			name: "Qwen 3.7 Max",
	...
	allModels.push(...qwencloudModels);
