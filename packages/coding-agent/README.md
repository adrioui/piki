...
**Custom providers & models:** Add providers via `~/.piki/agent/models.json` if they speak a supported API (OpenAI, Anthropic, Google). For custom APIs or OAuth, use extensions. See [docs/models.md](docs/models.md) and [docs/custom-provider.md](docs/custom-provider.md).
...
See `/hotkeys` for the full list. Customize via `~/.piki/agent/keybindings.json`. See [docs/keybindings.md](docs/keybindings.md).
...
Sessions auto-save to `~/.piki/agent/sessions/` organized by working directory.
...
| `.piki/settings.json` | Project (overrides global) |
...
Replace the default system prompt with `.piki/SYSTEM.md` (project) or `~/.piki/agent/SYSTEM.md` (global). Append without replacing via `APPEND_SYSTEM.md`.
...
```markdown
<!-- ~/.piki/agent/prompts/review.md -->
Review this code for bugs, security issues, and performance problems.
Focus on: {{focus}}
```

Place in `~/.piki/agent/prompts/`, `.piki/prompts/`, or a [pi package](#pi-packages) to share with others. See [docs/prompt-templates.md](docs/prompt-templates.md).
...
```markdown
<!-- ~/.piki/agent/skills/my-skill/SKILL.md -->
# My Skill
...
Place in `~/.piki/agent/skills/`, `~/.agents/skills/`, `.piki/skills/`, or `.agents/skills/` (from `cwd` up through parent directories) or a [pi package](#pi-packages) to share with others. See [docs/skills.md](docs/skills.md).
...
Place in `~/.piki/agent/extensions/`, `.piki/extensions/`, or a [pi package](#pi-packages) to share with others. See [docs/extensions.md](docs/extensions.md) and [examples/extensions/](examples/extensions/).

### Themes

Built-in: `dark`, `light`. Themes hot-reload: modify the active theme file and pi immediately applies changes.

Place in `~/.piki/agent/themes/`, `.piki/themes/`, or a [pi package](#pi-packages) to share with others. See [docs/themes.md](docs/themes.md).
...
|----------|-------------|
| `PI_CODING_AGENT_DIR` | Override config directory (default: `~/.piki/agent`) |
