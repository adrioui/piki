import { ProcessTerminal, setKeybindings, TUI } from "@piki/tui";
...
const OFFICIAL_PACKAGE_NAME = "@piki/coding-agent";
const OFFICIAL_APP_NAME = "piki";
const OFFICIAL_CONFIG_DIR_NAME = ".piki";
 ...
 * - this is the official Piki distribution
 * - experimental features are enabled (PIKI_EXPERIMENTAL=1)
