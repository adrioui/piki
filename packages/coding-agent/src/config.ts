...
export function getPackageDir(): string {
	...
	const envDir = process.env.PIKI_PACKAGE_DIR;
	if (envDir) {
...
export const PACKAGE_NAME: string = pkg.name || "@piki/coding-agent";
export const APP_NAME: string = piConfigName || "piki";
export const APP_TITLE: string = APP_NAME;
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".piki";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., PIKI_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://piki.run/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.PIKI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.piki/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.piki/agent/) */
