...
/**
 * Migrate sessions from ~/.piki/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.piki/agent/ instead of
 * ~/.piki/agent/sessions/<encoded-cwd>/. This migration moves them
