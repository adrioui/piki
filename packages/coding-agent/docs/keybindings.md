...
All keyboard shortcuts can be customized via `~/.piki/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.piki/agent/keybindings.json`:
