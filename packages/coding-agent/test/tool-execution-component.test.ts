...
import { Text, type TUI } from "@piki/tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".piki", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .piki/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Piki documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
