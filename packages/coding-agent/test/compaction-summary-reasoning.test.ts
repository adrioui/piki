...
import type { AssistantMessage, Model } from "@piki/ai";
...
vi.mock("@piki/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@piki/ai/compat")>();
	return {
		...actual,
