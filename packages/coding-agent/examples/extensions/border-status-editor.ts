import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@piki/coding-agent";
import type { Component, EditorTheme, TUI } from "@piki/tui";
import { truncateToWidth, visibleWidth } from "@piki/tui";
