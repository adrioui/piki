...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.PIKI_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.PIKI_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
	...
	private doRender(): void {
		...
		const debugRedraw = process.env.PIKI_DEBUG_REDRAW === "1";
		...
		// Configurable via setClearOnShrink() or PIKI_CLEAR_ON_SHRINK=0 env var
		...
		if (process.env.PIKI_TUI_DEBUG === "1") {
